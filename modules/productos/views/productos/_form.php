                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 ">
                            ...
                            'prepend' => [['content' => '<i class="fas fa-dollar-sign"></i>'],],]]
                        ...
                        <div class="col-md-12">
                            <div class="form-group field-subir-imagenes">
                                <label class="control-label" for="subir-imagenes[]">Imagen principal</label>
                                <div>
                                    <?= FileInput::widget([
                                        'name' =>'upload_ajax[]',
