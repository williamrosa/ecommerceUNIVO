...
/**
 * SubCategoriasSearch represents the model behind the search form of `app\modules\productos\models\SubCategorias`.
 */
class SubCategoriasSearch extends SubCategorias
{
    ...
    {
        return [
            [['id_sub_categoria', 'id_categoria', 'id_usuario_ing', 'id_usuario_mod', 'estado'], 'integer'],
    ...
    public function search($params)
    {
        ...
        if(!is_null($this->fecha_ing) && strpos($this->fecha_ing, ' - ') != false)
        {
            ...
            $query->andFilterWhere(['between', 'fecha_ing',$start_date . ' ' .
            '00:00:00', $end_date . ' ' . '23:59:59']);
        }
